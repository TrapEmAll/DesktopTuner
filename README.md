...
- Opens a companion File Explorer with a classic command strip, quick access to common folders and drives, current-folder name search, and a bottom details pane. Double-click folders to browse and files to launch with their default app.
