...
public static class ShellHostLaunchPolicy
{
    ...
    public static bool ShouldManageReplacementDesktop(bool shellHostMode, bool shellOverlayMode) =>
        shellHostMode || shellOverlayMode;
    ...
    public static bool ShouldRoutePinnedDirectoryToCompanionExplorer(bool shellHostMode, bool isDirectory) =>
        shellHostMode && isDirectory;
