...
Check(12, StartMenuPlaceCatalog.DropdownPlaces.Count, "show the supported Start places with dropdown navigation");
...
Check(23, defaultStartPlaces.Order!.Count, "include every supported system place in the default order");
Check(23, defaultStartPlaces.Visible!.Count, "show every system place by default");
...
preferencesStore.Save(expectedPreferences);
    ...
    Check(23, preferencesStore.Load().StartMenuPlaces!.Visible!.Count, "show all Start places for older preference files");
