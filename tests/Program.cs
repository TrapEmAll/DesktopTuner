...
Check(19, defaultStartPlaces.Order!.Count, "include every supported system place in the default order");
Check(19, defaultStartPlaces.Visible!.Count, "show every system place by default");
...
preferencesStore.Save(expectedPreferences);
    ...
    Check(19, preferencesStore.Load().StartMenuPlaces!.Visible!.Count, "show all Start places for older preference files");
