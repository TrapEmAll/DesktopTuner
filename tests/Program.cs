...
Check(8, StartMenuPlaceCatalog.AdditionalPlaces.Count, "show the remaining additional Start system places");
...
Check(16, defaultStartPlaces.Order!.Count, "include every supported system place in the default order");
Check(16, defaultStartPlaces.Visible!.Count, "show every system place by default");
...
Check("run,documents,downloads,music,pictures,videos,libraries,devices-printers,network,user-profile,computer,recycle-bin,control-panel,default-programs,network-connections,recent", string.Join(',', customStartPlaces.Order!), "retain a valid custom place order and append missing choices");
...
Check("run,documents,downloads,music,pictures,videos,libraries,devices-printers,network,user-profile,computer,recycle-bin,control-panel,default-programs,network-connections,recent", string.Join(',', StartMenuPlaceCatalog.Move(customStartPlaces, "run", -1).Order!), "keep the first system place at the top when moved upward");
...
preferencesStore.Save(expectedPreferences);
    ...
    Check(16, preferencesStore.Load().StartMenuPlaces!.Visible!.Count, "show all Start places for older preference files");
