...
Check(30, ControlPanelAppletCatalog.Applets.Count, "offer the supported Control Panel applets in the Start flyout");
...
Check(29, normalizedPartialControlPanelApplets.Visible!.Count, "default newly added Control Panel applets to visible for older saved preferences");
...
Check(30, ControlPanelAppletCatalog.Normalize(null).Visible!.Count, "show all Control Panel applets for older preference files");
...
preferencesStore.Save(expectedPreferences);
    ...
    Check(30, preferencesStore.Load().ControlPanelApplets!.Visible!.Count, "show all Control Panel applets for older preference files");
