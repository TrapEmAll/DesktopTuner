...
Check("run,documents,downloads,music,pictures,videos,libraries,devices-printers,network,user-profile,computer,recycle-bin,control-panel,recent", string.Join(',', customStartPlaces.Order!), "retain a valid custom place order and append missing choices");
...
Check("run,documents,downloads,music,pictures,videos,libraries,devices-printers,network,user-profile,computer,recycle-bin,control-panel,recent", string.Join(',', StartMenuPlaceCatalog.Move(customStartPlaces, "run", -1).Order!), "keep the first system place at the top when moved upward");
