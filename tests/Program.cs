...
{
    ((uint)'A', "Quick Settings"), ((uint)'G', "Game Bar"), ((uint)'I', "Settings"), ((uint)'K', "Connect"), ((uint)'N', "Notification Center"),
...
foreach (var key in new[] { (uint)'A', (uint)'G', (uint)'H', (uint)'I', (uint)'L', (uint)'N', (uint)'Q', (uint)'S', (uint)'U', (uint)'V', (uint)'W', (uint)'Z', 0x09u, 0x20u })
{
