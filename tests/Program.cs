...
Check(true, NativeTaskbarTrayService.ShouldUseMonitorIdentityFallback(false, true), "use monitor identity to focus a tray whose geometry is temporarily stale");
Check(false, NativeTaskbarTrayService.ShouldUseMonitorIdentityFallback(true, true), "prefer geometry when native tray bounds already overlap the display");
...
CheckTrue(TaskbarInteractionPolicy.ShouldShowProperties(System.Windows.Input.MouseButton.Left, System.Windows.Input.ModifierKeys.Alt), "use Alt-click to open taskbar item properties");
Check(false, TaskbarInteractionPolicy.ShouldShowProperties(System.Windows.Input.MouseButton.Left, System.Windows.Input.ModifierKeys.Control | System.Windows.Input.ModifierKeys.Alt), "keep Ctrl+Alt-click out of the taskbar properties gesture");
CheckTrue(TaskbarInteractionPolicy.ShouldShowProperties(System.Windows.Input.Key.Enter, System.Windows.Input.ModifierKeys.Alt), "use Alt+Enter to open properties for a focused taskbar item");
Check(false, TaskbarInteractionPolicy.ShouldShowProperties(System.Windows.Input.Key.Enter, System.Windows.Input.ModifierKeys.Control | System.Windows.Input.ModifierKeys.Alt), "keep Ctrl+Alt+Enter out of the taskbar properties gesture");
CheckTrue(TaskbarInteractionPolicy.ShouldShowSystemMenu(System.Windows.Input.MouseButton.Right, System.Windows.Input.ModifierKeys.Shift), "use Shift+right-click to open the native window system menu");
Check(false, TaskbarInteractionPolicy.ShouldShowSystemMenu(System.Windows.Input.MouseButton.Right, System.Windows.Input.ModifierKeys.Control | System.Windows.Input.ModifierKeys.Shift), "keep Ctrl+Shift+right-click out of the native system-menu gesture");
CheckTrue(TaskbarInteractionPolicy.ShouldShowContextMenu(System.Windows.Input.Key.F10, System.Windows.Input.ModifierKeys.Shift), "use Shift+F10 to open a focused taskbar button context menu");
Check(false, TaskbarInteractionPolicy.ShouldShowContextMenu(System.Windows.Input.Key.F10, System.Windows.Input.ModifierKeys.Control | System.Windows.Input.ModifierKeys.Shift), "keep Ctrl+Shift+F10 out of the taskbar context-menu gesture");
CheckTrue(TaskbarInteractionPolicy.ShouldShowContextMenu(System.Windows.Input.Key.Apps, System.Windows.Input.ModifierKeys.None), "use the keyboard context-menu key to open a focused taskbar button context menu");
Check(false, TaskbarInteractionPolicy.ShouldShowContextMenu(System.Windows.Input.Key.Apps, System.Windows.Input.ModifierKeys.Shift), "keep modified keyboard context-menu keys out of the taskbar gesture");
CheckTrue(StartMenuKeyboardPolicy.ShouldShowContextMenu(System.Windows.Input.Key.F10, System.Windows.Input.ModifierKeys.Shift), "use Shift+F10 to open a focused Start item context menu");
CheckTrue(StartMenuKeyboardPolicy.ShouldShowContextMenu(System.Windows.Input.Key.Apps, System.Windows.Input.ModifierKeys.None), "use the keyboard context-menu key to open a focused Start item context menu");
Check(false, StartMenuKeyboardPolicy.ShouldShowContextMenu(System.Windows.Input.Key.Apps, System.Windows.Input.ModifierKeys.Control), "keep modified keyboard context-menu keys out of the Start gesture");
