...
Check(41, ControlPanelAppletCatalog.Applets.Count, "offer the supported Control Panel applets in the Start flyout");
...
Check(40, normalizedPartialControlPanelApplets.Visible!.Count, "default newly added Control Panel applets to visible for older saved preferences");
...
Check(41, ControlPanelAppletCatalog.Normalize(null).Visible!.Count, "show all Control Panel applets for older preference files");
...
Check(11, defaultStartPlaces.Visible!.Count, "show every system place by default");
...
Check("run,documents,downloads,music,pictures,videos,computer,recycle-bin,control-panel,network,recent", string.Join(',', customStartPlaces.Order!), "retain a valid custom place order and append missing choices");
...
Check("run,documents,downloads,music,pictures,videos,computer,recycle-bin,control-panel,network,recent", string.Join(',', StartMenuPlaceCatalog.Move(customStartPlaces, "run", -1).Order!), "keep the first system place at the top when moved upward");
...
preferencesStore.Save(expectedPreferences);
    ...
    Check(41, preferencesStore.Load().ControlPanelApplets!.Visible!.Count, "show all Control Panel applets for older preference files");
