...
Check(11, StartMenuPlaceCatalog.DropdownPlaces.Count, "show the supported Start places with dropdown navigation");
...
Check(22, defaultStartPlaces.Order!.Count, "include every supported system place in the default order");
Check(22, defaultStartPlaces.Visible!.Count, "show every system place by default");
...
preferencesStore.Save(expectedPreferences);
    ...
    Check(22, preferencesStore.Load().StartMenuPlaces!.Visible!.Count, "show all Start places for older preference files");
