...
public sealed record PinnedTaskbarApp(string Name, string ExecutablePath, bool IsDirectory = false)
{
    ...
    [JsonIgnore]
    public bool CanShowJumpList => !IsDirectory && File.Exists(ExecutablePath);
}
