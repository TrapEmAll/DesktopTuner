...
public sealed class WindowsKeyStartHook : IDisposable
{
    ...
    private readonly Func<bool> _canOpenNarrator;
    private readonly Action _openNarrator;
    private readonly Func<bool> _canOpenSnippingTool;
    private readonly Action _openSnippingTool;
    private readonly Func<bool> _canOpenCopilot;
    private readonly Action _openCopilot;
    ...
    public WindowsKeyStartHook(Action showStartMenu, Func<int, bool>? canActivateTaskbarPin = null, Action<int>? activateTaskbarPin = null, Func<bool>? canFocusTaskbar = null, Action<bool>? focusTaskbar = null, bool replaceBareWindowsKey = true, Func<bool>? canOpenExplorer = null, Action? openExplorer = null, bool replaceControlEscape = false, Func<bool>? canToggleDesktop = null, Action? toggleDesktop = null, Func<bool>? canFocusTaskbarSystem = null, Action? focusTaskbarSystem = null, Func<bool>? canOpenPowerUserMenu = null, Action? openPowerUserMenu = null, Func<bool>? canOpenRunDialog = null, Action? openRunDialog = null, Func<bool>? canMinimizeAllWindows = null, Action? minimizeAllWindows = null, Func<bool>? canRestoreMinimizedWindows = null, Action? restoreMinimizedWindows = null, Func<uint, bool>? canOpenShellSystemSurface = null, Action<uint>? openShellSystemSurface = null, Func<bool>? canOpenOnScreenKeyboard = null, Action? openOnScreenKeyboard = null, Func<bool>? canOpenNarrator = null, Action? openNarrator = null, Func<bool>? canOpenSnippingTool = null, Action? openSnippingTool = null, Func<bool>? canOpenCopilot = null, Action? openCopilot = null, Func<int, bool>? canLaunchPinnedAppInstance = null, Action<int>? launchPinnedAppInstance = null, Func<int, bool>? canLaunchPinnedAppInstanceAsAdministrator = null, Action<int>? launchPinnedAppInstanceAsAdministrator = null, Func<int, bool>? canActivateLastActivePinnedApp = null, Action<int>? activateLastActivePinnedApp = null)
    {
        ...
        _canOpenNarrator = canOpenNarrator ?? (() => false);
        _openNarrator = openNarrator ?? (() => { });
        _canOpenSnippingTool = canOpenSnippingTool ?? (() => false);
        _openSnippingTool = openSnippingTool ?? (() => { });
        _canOpenCopilot = canOpenCopilot ?? (() => false);
        _openCopilot = openCopilot ?? (() => { });
    ...
    private nint KeyboardCallback(int code, nint wParam, nint lParam)
    {
        ...
        try
        {
            ...
            var canOpenOnScreenKeyboard = IsModifierPressed(VK_CONTROL) && !IsModifierPressed(VK_SHIFT) && !IsModifierPressed(VK_MENU)
                ...
                : static () => false;
            var canOpenNarrator = IsModifierPressed(VK_CONTROL) && !IsModifierPressed(VK_SHIFT) && !IsModifierPressed(VK_MENU)
                ? _canOpenNarrator
                : static () => false;
            var canOpenSnippingTool = IsModifierPressed(VK_SHIFT) && !IsModifierPressed(VK_CONTROL) && !IsModifierPressed(VK_MENU)
                ? _canOpenSnippingTool
                : static () => false;
            var canOpenCopilot = !IsModifierPressed(VK_SHIFT) && !IsModifierPressed(VK_CONTROL) && !IsModifierPressed(VK_MENU)
                ? _canOpenCopilot
                : static () => false;
            ...
            var action = message switch
            {
                WM_KEYDOWN or WM_SYSKEYDOWN => _gesture.KeyDown(data.VirtualKey, canActivateTaskbarPin, canFocusTaskbar, canOpenExplorer,
                    IsModifierPressed(VK_CONTROL), IsModifierPressed(VK_MENU), IsModifierPressed(VK_SHIFT), canToggleDesktop, canFocusTaskbarSystem, canOpenPowerUserMenu, canOpenRunDialog, canMinimizeAllWindows, canRestoreMinimizedWindows, canOpenShellSystemSurface, canOpenOnScreenKeyboard, canOpenNarrator, canOpenSnippingTool, canOpenCopilot, canLaunchPinnedAppInstance, canLaunchPinnedAppInstanceAsAdministrator, canActivateLastActivePinnedApp),
            ...
            switch (action)
            {
                ...
                case WindowsKeyAction.OpenOnScreenKeyboard:
                    ...
                    return new nint(1);
                case WindowsKeyAction.OpenNarrator:
                    Application.Current?.Dispatcher.BeginInvoke(_openNarrator, DispatcherPriority.Input);
                    return new nint(1);
                case WindowsKeyAction.OpenSnippingTool:
