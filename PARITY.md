...
| Taskbar | Labels, icon size, margins, grouping, drag/drop | Partial: window titles are shown and three bar sizes/grouping preference exist; icon sizing, margins, drag/drop, and persistent pinning remain |
